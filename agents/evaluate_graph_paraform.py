...
from agents.paraform_types import (
...
from agents.types import QueriesOutput
...
def generate_queries(state: ParaformEvaluationState):
    ...
    system_instructions_query = search_query_prompt.format(
